		...
		<view class="address-management">
			<view class="item">
				<view class="cu-bar bg-white solid-bottom">
					<view class="action">
						<text class="cuIcon-titles text-mauve"></text> 尿酸
					</view>
				</view>
...
<script>
	...
	import{getUricAcidByDay,getHealthArticleTop5} from "@/api/systemsetting.js"
	...
	export default {
		...
		methods: {
			...
			initData(){
				//this.dateStr = this.dateFormat("YYYY-mm-dd", this.dateObj)
				getUricAcidByDay(this.dateObj,this.uid).then(res => {
